export const dictionary = {
  pt: {
    ...
    aboutDescription: 'Manuel Pires Luís é um Desenvolvedor Full-Stack e Analista de QA com experiência em JavaScript, TypeScript, React, Node.js, Express, MongoDB, MySQL, HTML, CSS. Especializado em metodologias Ágeis e Scrum. Apaixonado por construir aplicações web escaláveis e responsivas, entregando software de alta qualidade.',
